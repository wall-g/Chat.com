    ...
    return (
        isLogin ?
            ...
            <div className='bg-blue-50 w-3/12 m-auto mt-8 p-4 text-sm'>
                ...
                <p className='w-3/12 m-auto p-2 text-blue-400 underline cursor-pointer hover:text-blue-500' onClick={() => setIsLogin(!isLogin)}>Register?</p>
            </div>
            ...
            <div className='bg-blue-50 w-1/4 m-auto mt-8 p-4 text-sm'>
                ...
                <p className='w-3/12 m-auto p-2 text-blue-400 underline cursor-pointer hover:text-blue-500' onClick={() => setIsLogin(!isLogin)}>Login?</p>
            </div>
